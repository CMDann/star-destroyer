...
var GameCode = {
    ...
    getScores: function() {
        ...
        var scores = this.getStoredScores();
        ...
        me.data.scores = me.data.scores || scores;
    ...
    saveScores: function() {
        ...
        var data = {};
        data[storage] = this.data.scores;

        // chrome.storage.local["scores"] = data;
...
*/
    ...
    getStoredScores: function(){
      // var scores = chrome.storage.local.get["scores"];
